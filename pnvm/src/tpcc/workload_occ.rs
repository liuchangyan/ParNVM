...
fn new_order(
    ...
    for i in 0..ol_cnt as usize {
        ...
        //println!("{}", s_dist);
        info!(
            "[{:?}][TXN-NEWORDER] PUSHING ORDERLINE  (w_id:{:?}, d_id:{}, o_id: {}, ol_cnt: {})",
            tid,
            w_id,
            d_id,
            o_id,
...
pub fn delivery(tx: &mut TransactionOCC, tables: &Arc<Tables>, w_id: i32, o_carrier_id: i32) {
    let tid = tx.id();
